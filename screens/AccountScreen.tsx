...
import { View, Text, TextInput, TouchableOpacity, ScrollView, Image, Alert, Platform, ActionSheetIOS } from "react-native";
...
export default function AccountScreen() {
	...
	return (
		<ScrollView style={tw`flex-1 bg-[${colors.background.primary}]`}>
			<View style={tw`p-6`}>
				{/* Header */}
				<Text style={tw`text-2xl font-bold text-[${colors.text.primary}] mb-6`}>Account Settings</Text>
				...
				<View style={tw`mb-6`}>
					...
					<TouchableOpacity
						...
						}] border border-dashed border-[${colors.primary.main}] rounded-xl ${isUploadingImage ? "opacity-50" : ""}`}
					...
					>
						...
						<Text style={tw`ml-2 text-[${colors.primary.main}] font-medium`}>
							{isUploadingImage ? "Uploading..." : formData.avatarUri ? "Photo Selected" : "Upload Profile Photo"}
						</Text>
					</TouchableOpacity>
				</View>
