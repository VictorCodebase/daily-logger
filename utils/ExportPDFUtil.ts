import { ExportOptions, WorkSchedulePeriod } from "../models/ViewModel_Models";
import { formatDate, ReportData } from "../stores/ExportViewModel";
 ...
 */
export const generateProfessionalHTML = (data: ReportData, options: ExportOptions): string => {
 ...
 */
export const generateMonotoneHTML = (data: ReportData, options: ExportOptions): string => {
    const currentDate = new Date().toLocaleDateString("en-US", {
        year: "numeric",
        month: "long",
        day: "numeric",
 ...
 */
export const generateSimpleHTML = (data: ReportData, options: ExportOptions): string => {
    const currentDate = new Date().toLocaleDateString("en-US", {
        year: "numeric",
        month: "long",
        day: "numeric",
 ...
 */
export const generateCreativeHTML = (data: ReportData, options: ExportOptions): string => {
    const currentDate = new Date().toLocaleDateString("en-US", {
        year: "numeric",
        month: "long",
        day: "numeric",
 ...
 */
export const savePDFToDevice = async (html: string, fileName: string): Promise<string> => {
    try {
